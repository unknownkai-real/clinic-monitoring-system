...
<div class="d-flex justify-content-between mb-3"><h4>Employee Management</h4><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#formModal" onclick="editRow()">Add Record</button></div>
<table id="tbl" class="table table-striped"><thead><tr><th>ID</th>employee_id</th><th>first_name</th><th>last_name</th><th>designation</th><th>department</th><th>medical_status</th><th>medical_note<th>Actions</th></tr></thead><tbody></tbody></table>
<div class="modal fade" id="formModal"><div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><h5>Employee Management Form</h5></div><div class="modal-body"><form id="frm"><input type="hidden" name="id" id="id"><input type="hidden" name="module" value="employees"><input type="hidden" name="action" value="save">
<div class="row g-2">
<div class='col-md-6'><label class='form-label'>employee id</label><input class='form-control' name='employee_id' id='employee_id' required></div>
...
<script>
const moduleName = 'employees'; let dt;
